...
class Event {
  ...
  @JsonKey(name: 'current_participants', fromJson: _parseInt)
  final int currentParticipants;
  @JsonKey(name: 'available_spots', fromJson: _parseInt)
  final int? availableSpots;
  @JsonKey(name: 'is_sold_out', fromJson: _parseBool)
  final bool isSoldOut;
  @JsonKey(name: 'is_active', fromJson: _parseBool)
  final bool isActive;
  @JsonKey(name: 'is_ongoing', fromJson: _parseBool)
  final bool isOngoing;
  @JsonKey(name: 'has_ended', fromJson: _parseBool)
  final bool hasEnded;
  ...
  @JsonKey(name: 'views_count', fromJson: _parseInt)
  ...
  @JsonKey(name: 'is_favorited', fromJson: _parseBool)
  final bool isFavorited;
  @JsonKey(name: 'user_is_registered')
  ...
  static double _parseDouble(dynamic value) {
    ...
    return 0.0; // Default value for null or unparseable data
  }
  ...
  static bool _parseBool(dynamic value) {
    ...
    return false; // Default value for null or unparseable data
  }
}